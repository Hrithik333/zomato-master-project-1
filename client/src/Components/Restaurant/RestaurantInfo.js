                ...
                <div className="flex flex-col flex-col-reverse md:flex-row md:items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-6 text-xs md:text-base">
                        <div className="flex items-center gap-2">
                            <span className="flex items-center gap-1 text-white font-medium bg-green-600 px-2 py-1 rounded-lg">
                                {props.restaurantRating}
                                <TiStarFullOutline />
                            </span>
                            <span>
                                <strong>12</strong>
                                <p className="border-b border-gray-600 border-dashed">Dining Reviews</p>
                            </span>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="flex items-center gap-1 text-white font-medium bg-green-600 px-2 py-1 rounded-lg">
                            ...
                            <span>
                                <strong>980</strong>
                                <p className="border-b border-gray-600 border-dashed">Delivery Reviews</p>
                            </span>
                        </div>
                    </div>
                </div>
